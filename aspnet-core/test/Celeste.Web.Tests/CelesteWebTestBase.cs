...
{
    public abstract class CelesteWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CelesteWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CelesteWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CelesteDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CelesteDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CelesteDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CelesteDbContext, Task<T>> func)
        {
            T result;
