...
namespace Celeste.Migrations
{
    ...
    [Migration("20201120144633_Added Ticket Management Functionality")]
    partial class AddedTicketManagementFunctionality
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Celeste.Modes.Mode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Celeste.Modes.ModeStats", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Celeste.Tickets.Ticket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Celeste.Tickets.TicketReply", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Celeste.UserModes.UserMode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Celeste.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Celeste.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Celeste.Authorization.Users.User", b =>
                {
                    ...
                    b.HasOne("Celeste.MultiTenancy.Tenant", null)
                        .WithMany("Users")
            ...
            modelBuilder.Entity("Celeste.Modes.ModeStats", b =>
                {
                    b.HasOne("Celeste.Modes.Mode", "Mode")
                        .WithMany()
            ...
            modelBuilder.Entity("Celeste.Tickets.TicketReply", b =>
                {
                    b.HasOne("Celeste.Tickets.Ticket", "Ticket")
                        .WithMany("Replies")
