...
export class ModeServiceProxy {
     ...
     * @return Success
     */
    getAllModes(): Observable<ModeListDtoListResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Mode/GetAllModes";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllModes(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllModes(<any>response_);
                } catch (e) {
                    return <Observable<ModeListDtoListResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<ModeListDtoListResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAllModes(response: HttpResponseBase): Observable<ModeListDtoListResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ModeListDtoListResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ModeListDtoListResultDto>(<any>null);
    }
     ...
     * @return Success
     */
    get(id: string | undefined): Observable<ModeListDto> {
        let url_ = this.baseUrl + "/api/services/app/Mode/Get?";
        if (id === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ModeListDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<ModeListDto>><any>_observableThrow(response_);
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<ModeListDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ModeListDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ModeListDto>(<any>null);
    }
     ...
     * @return Success
     */
    getAll(maxResultCount: number | undefined, skipCount: number | undefined): Observable<ModeListDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Mode/GetAll?";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ModeListDtoPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<ModeListDtoPagedResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<ModeListDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ModeListDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ModeListDtoPagedResultDto>(<any>null);
    }
     ...
     * @return Success
     */
    create(body: CreateModeInput | undefined): Observable<ModeListDto> {
        let url_ = this.baseUrl + "/api/services/app/Mode/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: HttpResponseBase): Observable<ModeListDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    update(body: GetModeOutput | undefined): Observable<ModeListDto> {
        let url_ = this.baseUrl + "/api/services/app/Mode/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<ModeListDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    delete(id: string | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Mode/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
...
export class TenantServiceProxy {
     ...
     * @return Success
     */
    updateTenant(body: UpdateTenantDto | undefined): Observable<void> {
     ...
     * @return Success
     */
    updateTenantDetails(body: TenantDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Tenant/UpdateTenantDetails";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUpdateTenantDetails(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateTenantDetails(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processUpdateTenantDetails(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class TicketServiceProxy {
     ...
     * @return Success
     */
    create(body: CreateTicketInput | undefined): Observable<TicketListDto> {
        let url_ = this.baseUrl + "/api/services/app/Ticket/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: HttpResponseBase): Observable<TicketListDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = TicketListDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
     ...
     * @return Success
     */
    update(body: TicketDto | undefined): Observable<TicketListDto> {
        let url_ = this.baseUrl + "/api/services/app/Ticket/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<TicketListDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getTickets(keyword: string | null | undefined, status: TicketStatus | undefined, userId: number | null | undefined, tenantId: number | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<TicketListDtoPagedResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<TicketListDtoPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<TicketListDtoPagedResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetTickets(response: HttpResponseBase): Observable<TicketListDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = TicketListDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<TicketListDtoPagedResultDto>(<any>null);
    }
     ...
     * @return Success
     */
    get(id: string | undefined): Observable<TicketListDto> {
        let url_ = this.baseUrl + "/api/services/app/Ticket/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
    ...
    protected processGet(response: HttpResponseBase): Observable<TicketListDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getAll(maxResultCount: number | undefined, skipCount: number | undefined): Observable<TicketListDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Ticket/GetAll?";
        if (maxResultCount === null)
            throw new Error("The parameter 'maxResultCount' cannot be null.");
        else if (maxResultCount !== undefined)
            url_ += "MaxResultCount=" + encodeURIComponent("" + maxResultCount) + "&";
    ...
    protected processGetAll(response: HttpResponseBase): Observable<TicketListDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
@Injectable()
export class TicketReplyServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    create(body: CreateTicketReplyInput | undefined): Observable<TicketReplyListDto> {
        let url_ = this.baseUrl + "/api/services/app/TicketReply/Create";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<TicketReplyListDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<TicketReplyListDto>><any>_observableThrow(response_);
        }));
    }

    protected processCreate(response: HttpResponseBase): Observable<TicketReplyListDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = TicketReplyListDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<TicketReplyListDto>(<any>null);
    }
     ...
     */
    delete(id: string | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/TicketReply/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
     ...
     * @return Success
     */
    get(id: string | undefined): Observable<TicketReplyListDto> {
        let url_ = this.baseUrl + "/api/services/app/TicketReply/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
    ...
    protected processGet(response: HttpResponseBase): Observable<TicketReplyListDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    update(body: TicketReplyListDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/TicketReply/Update";
        url_ = url_.replace(/[?&]$/, "");
...
export class UserServiceProxy {
     ...
     * @return Success
     */
    getAllUsers(): Observable<UserDtoListResultDto> {
    ...
    protected processGetAllUsers(response: HttpResponseBase): Observable<UserDtoListResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class ModeListDto implements IModeListDto {
    ...
    static fromJS(data: any): ModeListDto {
        data = typeof data === 'object' ? data : {};
        let result = new ModeListDto();
        result.init(data);
        return result;
    }
...
export class ModeListDtoListResultDto implements IModeListDtoListResultDto {
    items: ModeListDto[] | undefined;

    constructor(data?: IModeListDtoListResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items.push(ModeListDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ModeListDtoListResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new ModeListDtoListResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): ModeListDtoListResultDto {
        const json = this.toJSON();
        let result = new ModeListDtoListResultDto();
        result.init(json);
        return result;
...
export interface IModeListDtoListResultDto {
    items: ModeListDto[] | undefined;
}

export class ModeListDtoPagedResultDto implements IModeListDtoPagedResultDto {
    totalCount: number;
    items: ModeListDto[] | undefined;

    constructor(data?: IModeListDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ModeListDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new ModeListDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): ModeListDtoPagedResultDto {
        const json = this.toJSON();
        let result = new ModeListDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface IModeListDtoPagedResultDto {
    totalCount: number;
    items: ModeListDto[] | undefined;
}
...
export class CreateModeInput implements ICreateModeInput {
    ...
    static fromJS(data: any): CreateModeInput {
        data = typeof data === 'object' ? data : {};
        let result = new CreateModeInput();
        result.init(data);
        return result;
    }
...
export class GetModeOutput implements IGetModeOutput {
    ...
    static fromJS(data: any): GetModeOutput {
        data = typeof data === 'object' ? data : {};
        let result = new GetModeOutput();
        result.init(data);
        return result;
    }
...
export class UpdateTenantDto implements IUpdateTenantDto {
    ...
    init(_data?: any) {
        if (_data) {
            this.tenantDto = _data["tenantDto"] ? TenantDto.fromJS(_data["tenantDto"]) : <any>undefined;
        }
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["tenantDto"] = this.tenantDto ? this.tenantDto.toJSON() : <any>undefined;
        return data; 
    }
...
export class TicketReplyListDto implements ITicketReplyListDto {
    tenantId: number;
    ticketId: string;
    userId: number;
    body: string | undefined;
    ...
    constructor(data?: ITicketReplyListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): TicketReplyListDto {
        data = typeof data === 'object' ? data : {};
        let result = new TicketReplyListDto();
        result.init(data);
        return result;
    }
...
export interface ITicketReplyListDto {
    tenantId: number;
    ticketId: string;
    userId: number;
    body: string | undefined;
...
export class TicketListDto implements ITicketListDto {
    ...
    user: UserDto;
    replies: TicketReplyListDto[] | undefined;
    lastModificationTime: moment.Moment | undefined;
    lastModifierUserId: number | undefined;
    creationTime: moment.Moment;
    creatorUserId: number | undefined;
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["replies"])) {
                ...
                for (let item of _data["replies"])
                    this.replies.push(TicketReplyListDto.fromJS(item));
            }
            this.lastModificationTime = _data["lastModificationTime"] ? moment(_data["lastModificationTime"].toString()) : <any>undefined;
            this.lastModifierUserId = _data["lastModifierUserId"];
            this.creationTime = _data["creationTime"] ? moment(_data["creationTime"].toString()) : <any>undefined;
...
export class TicketListDtoPagedResultDto implements ITicketListDtoPagedResultDto {
    totalCount: number;
    items: TicketListDto[] | undefined;

    constructor(data?: ITicketListDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): TicketListDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new TicketListDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): TicketListDtoPagedResultDto {
        const json = this.toJSON();
        let result = new TicketListDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface ITicketListDtoPagedResultDto {
    totalCount: number;
    items: TicketListDto[] | undefined;
}

export class CreateTicketReplyInput implements ICreateTicketReplyInput {
    ticketId: string;
    tenantId: number;
    ticketStatus: TicketStatus;
    body: string | undefined;

    constructor(data?: ICreateTicketReplyInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateTicketReplyInput {
        data = typeof data === 'object' ? data : {};
        let result = new CreateTicketReplyInput();
        result.init(data);
        return result;
    }
...
export interface ICreateTicketReplyInput {
    ticketId: string;
    tenantId: number;
    ticketStatus: TicketStatus;
    body: string | undefined;
